...
API_KEY = "AIzaSyAvRDILSrj09Hw7m9CpVAUhyHahCvFz9jg"
CUSTOM_SEARCH_ENGINE = "004471671290647220837:gohfisvgvcu"
...
if __name__ == "__main__":
 img_list = getImageUrl("りんご", 25)
 print(img_list)
 getImage("apple", img_list)
