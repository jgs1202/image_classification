...
g = open('/Users/Aoyama/Documents/B4/Memorability_data/database/Memorability.csv', 'rt')
...
for j in range(32):
    ...
    for i in range(500):
        ...
        # print(grads_value[0][16][16][0])
        input_img_data += grads_value * step
        if abs(grads_value[0][16][16][0]) < 1e-6:
            break
    ...
    sp.misc.imsave('1sec_filter/%s_filter_%d.png' % (layer_name, filter_index[j]), img)
